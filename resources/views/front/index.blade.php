...
<body class="ttm-one-page-site">
    ...
    <div class="page ttm-bgcolor-grey">
        ...
        <!--header start-->
        <header id="ttm-home" class="header ttm-header-style-01">
                    ...
                    <div class="site-header-menu-inner ttm-stickable-header">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12">
                                    <!--site-navigation -->
                                    <div id="site-navigation" class="site-navigation d-flex flex-row align-items-center justify-content-between" data-sticky-height="70">
                                        <!-- site-branding -->
                                        <div class="site-branding ">
                                            <a class="home-link" href="index-2.html" title="Inoterior" rel="home">
                                                <img id="logo-img" width="195" height="55" class="img-fluid" src="{{asset('theme/images/logo.png')}}" alt="logo-img">
                                            </a>
                                        ...
                                        <div class="d-flex flex-row">
                                            ...
                                            <nav class="main-menu menu-mobile" id="menu">
                                                <ul class="menu">
                                                    <li class="active"><a data-scroll href="#ttm-home">Home</a></li>
                                            ...
                                            <div class="ttm-widget_header d-flex flex-row justify-content-between">
                                                ...
                                                <div class="widget_info d-flex flex-row align-items-center justify-content-end">
                                                    <div class="widget_icon">
                                                        <div class="ttm-icon ttm-icon_element-onlytxt ttm-icon_element-color-skincolor ttm-icon_element-size-md mb-0">
                                                    ...
                                                    <div class="widget_content">
                                                        ...
                                                        <h3 class="widget_number">+0 123 888 555</h3>
                                                    </div>
                                                </div><!-- widget-info end -->
                                            </div>
                                        </div>
                ...
                <rs-module id="rev_slider_1_1" style="display:none;" data-version="6.1.8">
                    ...
                    <div class="ttm-quickdetails-area">
                        <ul class="top-contact">
                            <li><i class="fa fa-map-marker ttm-textcolor-skincolor"></i>1456 MATKL,Mrooklyn,NY</li>
                            <li><i class="fa fa-phone ttm-textcolor-skincolor"></i>+23 435 654 789</li>
                            <li><i class="fa fa-envelope-o ttm-textcolor-skincolor"></i>Email: <a href="mailto:info@example.com.com">CONTACT@INTERIOR.COM</a></li>
                        </ul>
                    </div>
                                ...
                                <div class="widget widget_text clearfix">
                                    <div class="textwidget widget-text text-center ml_10 res-991-ml-0 mr-35 res-991-mr-0">
                                        <div class="footer-logo">
                                            <img width="205" height="65" id="footer-logo-img" class="img-fluid" src="{{asset('theme/images/footer-logo.svg')}}" alt="image">
                                        </div>
                                        <p>Inoterior design consultancy firm that brings sensitivity to the design top hotels, offices & homes around the world.</p>
                ...
                <div class="bottom-footer-text">
                    <div class="container">
                        <div class="row copyright">
                            <div class="col-md-12">
                                <div class="">
                                    <span>Copyright © {{date('Y')}} Ribye Designers by &nbsp;<a href="#" class="ttm-textcolor-skincolor">Designekta Studios</a></span>
                                </div>
                            </div>
                            <div class="col-md-12">
