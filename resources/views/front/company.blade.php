            ...
            <div class="row">
                <div class="col-lg-6 col-md-8">
                    ...
                    <div class="ttm_single_image-wrapper">
                        <img width="570" height="484" class="img-fluid" src="{{asset('theme/images/single-img-07.png')}}" alt="single_07">
                    </div>
                </div>
                    ...
                    <div class="pl-30 res-991-pl-0 res-991-mt-40">
                        ...
                        <div class="d-flex pl-5 mt-20 mb-30 ttm-bgcolor-skincolor position-relative z-index-2">
                            <div class="d-inline pl-25 pr-25 pt-15 pb-15 w-100 ttm-bgcolor-grey ttm-textcolor-darkgrey">
                                <p class="mb-0 font-size-17 fontweight-Medium"><em>“A great design aesthetic often blooms from strong roots of inspiration. When it comes to, this translates quite literally and truly. Almost umbilical connect with Nature combined”</em></p>
                            </div>
                        </div>
            ...
            <div class="row slick_slider mt-20 res-991-mt-0" data-slick='{"slidesToShow": 3, "slidesToScroll": 1, "arrows":false, "autoplay":false, "infinite":true, "responsive": [{"breakpoint":992,"settings":{"slidesToShow": 2}}, {"breakpoint":540,"settings":{"slidesToShow": 1}}]}'>
                    ...
                    <div class="featured-imagebox featured-imagebox-post style2">
                        <div class="featured-imagebox-post-inner">
                            <div class="featured-thumbnail">
                                <img width="650" height="510" class="img-fluid" src="{{asset('theme/images/blog/blog-01-650x510.jpg')}}" alt="image">
                            </div>
                ...
                <div class="ttm-box-col-wrapper col-lg-4">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style2">
                        <div class="featured-imagebox-post-inner">
                            <div class="featured-thumbnail">
                                <img width="650" height="510" class="img-fluid" src="{{asset('theme/images/blog/blog-02-650x510.jpg')}}" alt="image">
                            </div>
                            <div class="ttm-box-post-date">
                                <span class="ttm-entry-date">
                ...
                <div class="ttm-box-col-wrapper col-lg-4">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style2">
                        <div class="featured-imagebox-post-inner">
                            <div class="featured-thumbnail">
                                <img width="650" height="510" class="img-fluid" src="{{asset('theme/images/blog/blog-03-650x510.jpg')}}" alt="image">
                            </div>
                            <div class="ttm-box-post-date">
                                <span class="ttm-entry-date">
                ...
                <div class="ttm-box-col-wrapper col-lg-4">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style2">
                        <div class="featured-imagebox-post-inner">
                            <div class="featured-thumbnail">
                                <img width="650" height="510" class="img-fluid" src="{{asset('theme/images/blog/blog-04-650x510.jpg')}}" alt="image">
                            </div>
                            <div class="ttm-box-post-date">
                                <span class="ttm-entry-date">
                ...
                <div class="ttm-box-col-wrapper col-lg-4">
                    ...
                    <div class="featured-imagebox featured-imagebox-post style2">
                        <div class="featured-imagebox-post-inner">
                            <div class="featured-thumbnail">
                                <img width="650" height="510" class="img-fluid" src="{{asset('theme/images/blog/blog-05-650x510.jpg')}}" alt="image">
                            </div>
                            <div class="ttm-box-post-date">
                                <span class="ttm-entry-date">
                                    <time class="entry-date" datetime="2019-01-16T07:07:55+00:00">20<span class="entry-month entry-year">Mar</span></time>
